...
class SinglyLinkedList {
  ...
  //removing a new node from the begining of the linkedlist
  shift() {
    if (!this.head) return undefined;
  ...
  //retrieve a node by its position in the linkedlist
  get(index) {
  ...
  //***reverse a SinglyLinkedList in place***
  reverse() {
    let node = this.head;
    this.head = this.tail;
    this.tail = node;
  ...
  //see the values in the linkedlist
  print() {
    let arr = [];
    let current = this.head;
